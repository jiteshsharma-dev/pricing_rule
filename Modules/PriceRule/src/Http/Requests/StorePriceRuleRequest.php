...
public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:255', 'alpha_dash', 'unique:price_rules,slug'],
            ...
            'coupons.*.code' => ['required_with:coupons', 'string', 'max:100', 'distinct', 'unique:price_rule_coupons,code'],
