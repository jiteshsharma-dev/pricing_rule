                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    {{-- <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <button type="button"
                                    class="group relative flex items-center gap-3 p-4 rounded-xl border-2 border-gray-100 hover:border-indigo-300 hover:bg-gradient-to-br hover:from-indigo-50 hover:to-purple-50 transition-all duration-200 text-left overflow-hidden"
                                ...
                                <div class="relative z-10">
                                    <div class="font-semibold text-gray-900 text-sm group-hover:text-indigo-700 transition">Cart Discount</div>
                                    <div class="text-xs text-gray-500">Order value based discount</div>
                                </div>
                            </button>
                            ...
                            <button type="button"
                                ...
                                <span class="text-2xl relative z-10">🎁</span>
                                <div class="relative z-10">
                                    <div class="font-semibold text-gray-900 text-sm group-hover:text-indigo-700 transition">Buy X Get Y</div>
                                    <div class="text-xs text-gray-500">Purchase reward offer</div>
                                </div>
                            </button>
                            ...
                            <button type="button"
                                ...
                                <span class="text-2xl relative z-10">🚚</span>
                                <div class="relative z-10">
                                    <div class="font-semibold text-gray-900 text-sm group-hover:text-indigo-700 transition">Free Shipping</div>
                                    <div class="text-xs text-gray-500">Shipping promotion</div>
                                </div>
                            </button>
                        </div>
                    </div> --}}
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <select name="status" id="status"
                                    ...
                                    @foreach(['draft' => '📝 Draft', 'active' => '✅ Active', 'expired' => '⏰ Expired'] as $value => $label)
                    ...
                    {{-- ─────────────────────────────────────────────── --}}
                    {{-- COLLAPSIBLE SECTIONS MACRO --}}
                    {{-- Each section follows the same pattern --}}
                    {{-- ─────────────────────────────────────────────── --}}

                    @php
                    $sections = [
                        ['id' => 'conditions', 'title' => 'Conditions', 'subtitle' => 'When should this rule apply?', 'icon_bg' => 'bg-amber-100', 'icon_color' => 'text-amber-600', 'icon' => 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4', 'btn' => 'addCondition()', 'btn_text' => 'Add Condition', 'required' => false],
                        ['id' => 'actions', 'title' => 'Actions', 'subtitle' => 'What discount/action to apply?', 'icon_bg' => 'bg-green-100', 'icon_color' => 'text-green-600', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z', 'btn' => 'addAction()', 'btn_text' => 'Add Action', 'required' => true],
                        ['id' => 'products', 'title' => 'Products', 'subtitle' => 'Target specific products', 'icon_bg' => 'bg-blue-100', 'icon_color' => 'text-blue-600', 'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', 'btn' => 'addProduct()', 'btn_text' => 'Add Product', 'required' => false],
                        ['id' => 'categories', 'title' => 'Categories', 'subtitle' => 'Target specific categories', 'icon_bg' => 'bg-purple-100', 'icon_color' => 'text-purple-600', 'icon' => 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z', 'btn' => 'addCategory()', 'btn_text' => 'Add Category', 'required' => false],
                        ['id' => 'customer-groups', 'title' => 'Customer Groups', 'subtitle' => 'Restrict to specific segments', 'icon_bg' => 'bg-teal-100', 'icon_color' => 'text-teal-600', 'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', 'btn' => 'addCustomerGroup()', 'btn_text' => 'Add Group', 'required' => false],
                        ['id' => 'coupons', 'title' => 'Coupons', 'subtitle' => 'Manage coupon codes', 'icon_bg' => 'bg-rose-100', 'icon_color' => 'text-rose-600', 'icon' => 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z', 'btn' => 'addCoupon()', 'btn_text' => 'Add Coupon', 'required' => false],
                        // ['id' => 'schedules', 'title' => 'Schedules', 'subtitle' => 'Set recurring time windows', 'icon_bg' => 'bg-cyan-100', 'icon_color' => 'text-cyan-600', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'btn' => 'addSchedule()', 'btn_text' => 'Add Schedule', 'required' => false],
                        // ['id' => 'targets', 'title' => 'Targets', 'subtitle' => 'Store / channel targeting', 'icon_bg' => 'bg-orange-100', 'icon_color' => 'text-orange-600', 'icon' => 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z', 'btn' => 'addTarget()', 'btn_text' => 'Add Target', 'required' => false],
                    ];
                    @endphp

                    @foreach($sections as $sec)
                    @php
                        $oldKey = str_replace('-', '_', $sec['id']);
                        $oldData = old($oldKey, []);
                        $isOpen = ($sec['id'] === 'actions') ? 'true' : (count($oldData) > 0 ? 'true' : 'false');
                    @endphp
                        ...
                        <div x-show="open" x-collapse>
                            <div class="px-6 pb-6 border-t border-gray-100">
                                ...
                                <div id="{{ $sec['id'] }}-wrapper" class="space-y-3">
                                    {{-- Old data rows rendered by JS or Blade --}}
                                </div>

                                <div id="{{ $sec['id'] }}-empty" class="{{ count($oldData) > 0 ? 'hidden' : '' }} text-center py-8 text-sm">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-shadow duration-300">
                            ...
                            <div class="space-y-4">
                                <div class="border-l-[3px] border-amber-400 pl-3 py-1">
                                    ...
                                    <p class="text-sm text-gray-700" id="preview-conditions">No conditions set — applies to all</p>
                                </div>
                                ...
                                <div class="border-l-[3px] border-green-400 pl-3 py-1">
                                    ...
                                    <p class="text-sm text-gray-700" id="preview-actions">No action defined yet</p>
                                </div>
                                ...
                                <div class="border-l-[3px] border-indigo-400 pl-3 py-1">
                                    ...
                                    <span id="preview-status" class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold bg-gray-100 text-gray-700">Draft</span>
                                </div>
                                ...
                                <div class="border-l-[3px] border-cyan-400 pl-3 py-1">
                                    ...
                                    <p class="text-sm text-gray-700" id="preview-schedule">Always active</p>
                                </div>
                                ...
                                <div class="border-l-[3px] border-rose-400 pl-3 py-1">
                                    ...
                                    <p class="text-sm text-gray-700" id="preview-coupon">Not required</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl border border-indigo-100/80 p-5 shadow-sm">
                            ...
                            <ul class="space-y-2.5 text-xs text-indigo-700/90">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>Use <strong class="text-indigo-800">priority</strong> to control which rules fire first (lower = higher).</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-indigo-400 flex-shrink-0"></span>
                                    <span>Enable <strong class="text-indigo-800">Stop Further Rules</strong> to prevent stacking.</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-indigo-400 flex-shrink-0"></span>
                                    <span>Add <strong class="text-indigo-800">conditions</strong> like <code class="bg-white/70 px-1.5 py-0.5 rounded-md text-indigo-600 font-mono text-[10px]">subtotal >= 500</code></span>
                                </li>
                                {{-- <li class="flex items-start gap-2">
                                    <span class="mt-1.5 w-1.5 h-1.5 rounded-full bg-indigo-400 flex-shrink-0"></span>
                                    <span>Use <strong class="text-indigo-800">schedules</strong> for recurring promos (e.g., every weekend).</span>
                                </li> --}}
                            </ul>
                        </div>
...
<script>
    ...
    function makeDeleteBtn(rowClass, section) {
        return '<button type="button" onclick="removeRow(this, \'' + rowClass + '\', \'' + section + '\')" class="p-2.5 text-gray-300 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all duration-200">' + deleteSvg + '</button>';
    }
    ...
    function addCoupon() {
        ...
        var html = '<div class="coupon-row ' + rowCls + '">'
            + '<div class="flex-1 min-w-[140px]">'
            + '<input type="text" name="coupons[' + i + '][code]" class="' + inputCls + ' font-mono uppercase tracking-wider" placeholder="COUPON CODE" oninput="updatePreview()">'
            + '</div>'
            + '<div class="w-28">'
            + '<select name="coupons[' + i + '][type]" class="' + inputCls + '">'
            + '<option value="shared">Shared</option><option value="unique">Unique</option>'
            + '</select></div>'
            + '<div class="w-28">'
            + '<input type="number" name="coupons[' + i + '][usage_limit]" class="' + inputCls + '" placeholder="Limit">'
            + '</div>'
            + '<div class="flex items-center gap-2">'
            ...
            + '<input type="checkbox" name="coupons[' + i + '][is_active]" value="1" class="w-4 h-4 rounded-md border-gray-300 text-indigo-600 focus:ring-indigo-500 shadow-sm" checked>'
            + 'Active</label></div>'
    ...
    function addSchedule() {
        ...
        var html = '<div class="schedule-row ' + rowCls + '">'
            ...
            + '</select></div>'
            + '<div class="w-24"><input type="number" name="schedules[' + i + '][day_of_week]" class="' + inputCls + '" placeholder="Day 0-6"></div>'
            + '<div class="w-24"><input type="number" name="schedules[' + i + '][day_of_month]" class="' + inputCls + '" placeholder="Day 1-31"></div>'
            + '<div class="w-32"><input type="time" name="schedules[' + i + '][time_from]" class="' + inputCls + '" onchange="updatePreview()"></div>'
            + '<div class="w-32"><input type="time" name="schedules[' + i + '][time_to]" class="' + inputCls + '" onchange="updatePreview()"></div>'
        ...
        if (previewAct) {
            if (actRows.length === 0) {
                ...
                actRows.forEach(function(row) {
                    ...
                    if (val) {
                        ap.push('Apply ' + val + (type.indexOf('percentage') !== -1 ? '%' : '₹') + ' ' + label);
                    } else {
                        ap.push(label);
                    }
                });
    ...
    function applyTemplate(type) {
        ...
        if (type === 'cart_discount') {
            ...
            addCondition();
            var cf = document.querySelector('.condition-row:last-child [name*="[field]"]');
            var co = document.querySelector('.condition-row:last-child [name*="[operator]"]');
            var cv = document.querySelector('.condition-row:last-child [name*="[value]"]');
            if (cf) cf.value = 'subtotal';
            if (co) co.value = '>=';
            if (cv) cv.value = '500';
            addAction();
            var at = document.querySelector('.action-row:last-child [name*="[action_type]"]');
            var av = document.querySelector('.action-row:last-child [name*="[configuration][value]"]');
            if (at) at.value = 'percentage_discount';
            if (av) av.value = '10';
        } else if (type === 'bxgy') {
            ...
            nameInput.dispatchEvent(new Event('input'));
            addCondition();
            var bf = document.querySelector('.condition-row:last-child [name*="[field]"]');
            var bo = document.querySelector('.condition-row:last-child [name*="[operator]"]');
            var bv = document.querySelector('.condition-row:last-child [name*="[value]"]');
            if (bf) bf.value = 'quantity';
            if (bo) bo.value = '>=';
            if (bv) bv.value = '2';
            addAction();
            var bt = document.querySelector('.action-row:last-child [name*="[action_type]"]');
            var ba = document.querySelector('.action-row:last-child [name*="[configuration][value]"]');
            if (bt) bt.value = 'fixed_discount';
            if (ba) ba.value = '0';
            ...
            nameInput.dispatchEvent(new Event('input'));
            addAction();
            var ft = document.querySelector('.action-row:last-child [name*="[action_type]"]');
            if (ft) ft.value = 'free_shipping';
        }
        updatePreview();
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        ['condition-row', 'action-row', 'coupon-row', 'schedule-row'].forEach(function(cls) {
            document.querySelectorAll('.' + cls + ' input, .' + cls + ' select').forEach(function(el) {
